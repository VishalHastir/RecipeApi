...
import com.recipe.api.enums.SearchCondition;
...
public class RecipeSearchRequest {
	...
	@Schema(description = "Search type (AND or OR condition) ", example = "AND", required = true)
    @EnumValidator(enumClass = SearchCondition.class, message = "{searchCondition.invalid}")
    @JsonProperty("type")
