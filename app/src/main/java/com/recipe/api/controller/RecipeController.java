 ...
 */
@Tag(name = "Recipe Controller", description = "Create, Update, Delete, and Get Recipes")
@RestController
...
public class RecipeController {
	...
	public ResponseEntity<RecipeResponse> createRecipe(
		...
		return new ResponseEntity<>(new RecipeResponse(id), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<RecipeResponse>> searchRecipes(
		...
		logger.info("Searching recipes with filters");
