...
public class RecipeControllerTest {
    ...
    public void testCreateRecipe() {
        RecipeRequest request = new RecipeRequest(null, "Chicken Pasta", "NON_VEGETARIAN", 4,
                Collections.singletonList("Chicken,sauce, pasta"), "Cook pasta and mix with sauce");
    ...
    public void testGetAllRecipes() {
        ...
        recipe1.setId(5);
        recipe1.setName("Chicken Pasta");

        RecipeResponse recipe2 = new RecipeResponse();
        recipe2.setId(6);
        recipe2.setName("Chicken Noodles");
    ...
    public void testUpdateRecipe() {
        RecipeRequest request = new RecipeRequest(1, "Chicken Noodles", "NON_VEGETARIAN", 4,
                Collections.singletonList("chicken, sauce, noodles"), "Cook chicken and mix with sauce");
